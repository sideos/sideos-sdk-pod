...
s.name = "iDenfySDK-Static"
s.summary = "iDenfy IOS Static SDK"
s.requires_arc = true
# 2
s.version = "0.6.7"
# 3
...
s.source = { :http => "https://s3-eu-west-1.amazonaws.com/sdk.builds/ios-sdk/0.6.7/static/iDenfySDKxcf.zip"}
s.framework = "UIKit"
s.dependency 'lottie-ios'
s.dependency 'ZIPFoundation', '0.9.11'

s.default_subspec = 'iDenfySDK-Static'
s.subspec 'iDenfySDK-Static' do |idenfySdk|
...
s.subspec 'iDenfyLiveness-Static' do |liveness|
...
s.subspec 'iDenfyRecognition-Static' do |recognition|
